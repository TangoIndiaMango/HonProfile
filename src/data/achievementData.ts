...
export const achievementProjects: AchievementProject[] = [
    ...
    mediaItems: [
      {
        id: 1,
        type: 'image' as const,
        url: '/works/aiyegunle-town-hall.jpg',
        title: 'Aiygunle Town Hall Project',
      },
      {
        id: 2,
        type: 'image' as const,
        url: '/works/good-road-network.jpg',
        title: 'Good Road Network Project',
      },
      {
        id: 3,
        type: 'video' as const,
        media: 'https://res.cloudinary.com/aliyu-timi/video/upload/v1759231894/compressed_adeogun2_iz71lu.mp4',
        url: '/works/oba-akoko-townhall.jpg',
      ...
      // },
      {
        ...
        url: '/works/adeogun-engineer.jpg',
      ...
      // },
      {
        ...
        url: '/works/motor_park_chairma-adeogun.png',
    ...
    mediaItems: [
      {
        ...
        url: '/works/ahmad-joy.png',
        title: 'Student Testimonial - Ahmadu Joy',
      },
      {
        id: 1,
        type: 'image' as const,
        url: '/works/administrative-block-rennovation.jpg',
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        id: 10,
        date: '-',
        title: 'Mediated and Resolved Land Dispute Between Supare and Oka Farming Communities',
        status: 'completed' as const,
      }
    ],
    mediaItems: [
      ...
      //   url: '/works/chief_mrs_to_adeogun.jpg',
  ...
  },
  {
    ...
    mediaItems: [
      ...
      //   id: 3,
      //   type: 'image' as const,
      //   url: '/moments/human_development_3.jpg',
      ...
      // },
      {
        ...
        url: '/moments/musical_instructor_adeogun.jpg',
      ...
      },
      {
        ...
        url: '/moments/photograph_booth.jpg',
      ...
      },
      {
        ...
        url: '/moments/changed_perception_adeogun.jpg',
  ...
  },
  {
    ...
    mediaItems: [
      ...
      //   id: 3,
      //   type: 'image' as const,
      //   url: '/works/employment_initiative_3.jpg',
  ...
  },
  {
    ...
    mediaItems: [
      ...
      //   id: 1,
      //   type: 'image' as const,
      //   url: '/works/artisans_and_farmers_support_1.jpg',
      ...
      // },
      {
        ...
        url: '/works/adeogun_speech_welfare.jpg',
